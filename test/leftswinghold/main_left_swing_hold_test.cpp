...
namespace {
void printUsage() {
    std::cout << "Usage: main_left_swing_hold_test [robot-id] Viewer [y/n] [torso-z-offset-m]\n"
...
int main(int argc, char** argv) {
    ...
    LeftSwingHoldTestRunner runner(RobotType::MIT_HUMANOID, controller.get(), headless, torsoZOffset);
    runner.init();
    runner.run();
    return EXIT_SUCCESS;
}
